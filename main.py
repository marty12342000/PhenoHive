...
def init():
	...
	global LED, token, org, bucket, url, path, pot_limit, channel, kernel_size, fill_size, cam, client, disp, WIDTH, HEIGHT, but_left, but_right, hx711, tare, raw_weight
...
def show_cal_menu():
    ...
    #Menu
    font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 10)
    draw.text((5, 80), "Tare :" +  str(tare), font=font, fill=(0, 0, 0))
    draw.text((5, 80), "Raw_value :" +  str(raw_weight), font=font, fill=(0, 0, 0))
    #Button
    font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 10)
